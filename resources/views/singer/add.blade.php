            ...
            <form action="{{ route('singer.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" name="date_and_birth" aria-describedby="emailHelp" value="{{ old('name') }}" placeholder="date and birth">
                  </div>
                <div class="form-group">
