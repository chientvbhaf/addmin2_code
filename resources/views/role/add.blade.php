            ...
            <form action="{{ route('role.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group col-md-6">
                    ...
                    <br>
                    <textarea name="display_name" id="display_name" cols="43" rows="5" class="">{{ old('display_name') }}</textarea>
                </div>
                ...
                @foreach ($permissionsParent as $Parenttitem)
                <div class="card col-md-12">
                  ...
                  <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="checkbox" class="checkbox_childrent" name="permisstionChildrent[]" id="" value="{{ $Childrentitem->id }}">
                          {{ $Childrentitem->name }}
                      </div>
                        @endforeach
